...
# usage: [b, varb, e, ess] = mc_ridgeregression(y, x, names, silent, regularvc)
# Calculates ridge regressionor LS estimator using the Huber-White heteroscedastic
# consistent variance estimator. The prior precision is chosen endogenously
# to allow a maximum of 5% increase in the sum of squared errors
#
# inputs:
# y: dep variable
...
function [b, varb, e, ess] = mc_ridgeregression(y, x, names, silent, regularvc)
	k = columns(x);
