...
#
# snm_covariance: estimates the Omega covariance matrix by Monte Carlo,
#	for given instruments
# usage: omega = snm_covariance(theta, data, momentargs, reps, verbose)
#
# inputs:
...
function omega = snm_covariance(theta, data, momentargs, reps, verbose)
	...
	for rep = 1:reps
		...
		[ce, ue, trim] = snm_residuals(theta, data, momentargs);
