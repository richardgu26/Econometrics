...
# V: estimated covariance of parameters
# obj_value: the value of the log likelihood function at ML estimate
# infocrit: 3X1 vector: CAIC, BIC, AIC
...
# report results
function [theta, V, obj_value, infocrit, convergence] = mle_results(theta, data, model, modelargs, names, mletitle, unscale, control, nslaves)
