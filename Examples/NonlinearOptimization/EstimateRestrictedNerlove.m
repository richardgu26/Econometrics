...
thetahat = fminunc(@(theta) (y-x*theta)'*(y-x*theta), thetastart);
...
R = [0 0 1 1 1];
r = 1;       
[thetahat, logL] = sqp(thetastart, @(theta) (y-x*theta)'*(y-x*theta), @(theta) R*theta-r, [], lb, ub); %Octave replacement for fmincon
thetahat
